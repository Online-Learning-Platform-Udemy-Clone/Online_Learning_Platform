...
export default function Payment() {
  ...
  const handlePay = async () => {
    ...
    try {
      ...
      // Log payload to debug 400 Bad Request issues and verify all fields are present
      console.log("Sending payload to /student-api/pay:", { student: studentId, course: courseId, amount: paymentAmount, method, transactionId: txnId, status: "SUCCESS" });
